...
class QuestionBank {
    ...
    init(){
        ...
        list.append(Question(text: "In London, UK, if you happend to die in the House of Parliament, you are technically entitled to a state funeral, because the building is considered too sacred a place." , correctAnswer: false))
        ...
        list.append(Question(text: "Buzz Aldrin's mother's maiden name \"Moon\".", correctAnswer: true))
        
        list.append(Question(text: "The loudest sound produced by any animal is 188 decibels. That animal is the African Elephant.", correctAnswer: false))
        list.append(Question(text: "No piece if square dry paper can be folded in half more than 7 times.", correctAnswer: false))
